...
## Relation to the Paper Pipeline
...
- **Page limit:** 9 pages + references (main content)
- **Format:** Double-blind, max 9 pages, anonymous submission
- **Font:** 10pt Times or similar serif
- **Structure:** Abstract, 1. Introduction, 2. Related Work, 3. Method, 4. Experiments, 5. Discussion/Conclusion
- **References:** Unlimited, use author-year style
- **Template:** https://nips.cc/Conferences/2025/PaperInformation/StyleFiles

### ICML (International Conference on Machine Learning)
- **Page limit:** 8 pages + references (+1 additional page allowed for ethics/broader impact)
- **Format:** Double-blind, requires broader impact statement
- **Font:** 10pt Times
- **Structure:** Abstract, 1. Introduction, 2. Background, 3. Method, 4. Experiments, 5. Related Work, 6. Conclusion, Broader Impact
- **Template:** https://icml.cc/Conferences/2025/StyleFiles

### ICLR (International Conference on Learning Representations)
- **Page limit:** 9 pages + references
- **Format:** Double-blind, requires reproducibility checklist
- **Font:** 10pt Times
- **Structure:** Abstract, 1. Introduction, 2. Related Work, 3. Preliminaries, 4. Method, 5. Experiments, 6. Conclusion
- **Template:** https://iclr.cc/Conferences/2025/StyleFiles

### Common Requirements (all three)
- **Figures:** PDF vector graphics, min 300 DPI
- **Tables:** Use booktabs-style formatting
- **Equations:** LaTeX math
- **Citations:** Author-year (Natbib/BibTeX)
- **Appendices:** Allowable but not counted in page limit; reviewers not required to read them
- **Checklist:** NeurIPS and ICLR require a checklist; ICML requires broader impact
