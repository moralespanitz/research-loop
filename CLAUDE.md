...
| `autonomous-iteration` | User has a measurable metric and wants automated optimization; or invokes $research-loop (plan, debug, fix, security, ship, scenario, predict, learn, reason, probe) |
...
| `experiment-sandbox` | User needs to run experiments in a sandboxed environment (local, Docker, SSH, Colab) |
